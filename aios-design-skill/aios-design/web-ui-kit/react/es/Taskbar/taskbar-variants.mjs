...
//#region src/Taskbar/taskbar-variants.ts
/**
* Taskbar 的视觉变体。
*
...
/** 开始按钮。 */
const taskbarStartVariants = cva([
...
* 不属于被禁的「阴影 / blur / 渐变」。
*/
const taskbarAppIconVariants = cva([
	"flex size-6 items-center justify-center",
	"[&_img]:size-full [&_img]:rounded-xs [&_img]:object-contain",
	"[&_svg]:size-full [&_svg]:fill-current"
], {
	variants: { theme: {
		light: "[&_img]:[filter:brightness(0)_saturate(100%)_invert(20%)_sepia(0%)_saturate(200%)_hue-rotate(0deg)_brightness(95%)_contrast(90%)]",
...
/** 托盘里的只读图标（音量等）。 */
const taskbarTrayIconVariants = cva([
...
*/
const taskbarBatteryVariants = cva(["flex cursor-default items-center gap-1 [-webkit-tap-highlight-color:transparent]"], {
	variants: {
		theme: {
			light: "text-[var(--widget-dark-2)]",
			dark: "text-[var(--widget-white)]"
...
//#endregion
export { taskbarAppIconVariants, taskbarAppVariants, taskbarBatteryFillVariants, taskbarBatteryPercentVariants, taskbarBatteryVariants, taskbarSearchVariants, taskbarStartVariants, taskbarTimeVariants, taskbarTrayIconVariants, taskbarVariants };

//# sourceMappingURL=taskbar-variants.mjs.map