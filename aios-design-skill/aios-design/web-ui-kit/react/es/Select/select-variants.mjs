...
const selectLabelVariants = cva(["mb-xs block font-mono text-label uppercase tracking-wider text-foreground-muted"]);
/**
* 触发器。
*
...
const selectPositionerVariants = cva(["z-[var(--z-overlay)]"]);
/**
* 浮层。
*
