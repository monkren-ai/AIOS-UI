...
//#region src/DateField/date-field-variants.ts
/**
* 日期分格输入。
*
...
*/
const dateFieldVariants = cva(["flex flex-col gap-1"], {
	variants: {
		size: {
			sm: "",
			md: "",
...
const dateFieldInputVariants = cva([
...
//#endregion
export { dateFieldInputVariants, dateFieldSegmentVariants, dateFieldVariants };

//# sourceMappingURL=date-field-variants.mjs.map