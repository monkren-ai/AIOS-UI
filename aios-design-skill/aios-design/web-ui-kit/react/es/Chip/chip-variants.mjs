...
//#region src/Chip/chip-variants.ts
...
const chipGroupVariants = cva("flex max-w-full items-center gap-2 overflow-x-auto overscroll-x-contain py-1");
//#endregion
export { chipGroupVariants, chipVariants };

//# sourceMappingURL=chip-variants.mjs.map