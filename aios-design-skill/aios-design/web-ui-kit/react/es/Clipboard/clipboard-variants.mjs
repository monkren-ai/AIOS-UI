...
const clipboardTitleVariants = cva(["font-mono uppercase tracking-widest text-foreground-muted", "transition-colors duration-200 ease-aios motion-reduce:transition-none"], {
	variants: { size: {
		sm: "text-micro",
		md: "text-label",
		lg: "text-caption"
...
const clipboardCountVariants = cva(["font-mono text-caption text-foreground-disabled", "transition-colors duration-200 ease-aios motion-reduce:transition-none"]);
...
const clipboardTimeVariants = cva(["text-start font-mono text-caption text-foreground-disabled", "transition-colors duration-200 ease-aios motion-reduce:transition-none"]);
