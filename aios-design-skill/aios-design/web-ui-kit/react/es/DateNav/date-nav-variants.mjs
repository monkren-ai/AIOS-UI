...
//#region src/DateNav/date-nav-variants.ts
/** 月份翻页条。整体禁用时统一降透明度并吃掉指针事件。 */
const dateNavVariants = cva(["inline-flex items-center gap-1"], {
	variants: { disabled: {
...
*/
const dateNavLabelVariants = cva(["min-w-30 whitespace-nowrap text-center text-sm uppercase tracking-wider tabular-nums text-foreground"], {
	variants: { grotesk: {
		true: "font-body",
		false: "font-mono"
	} },
...
const dateNavArrowVariants = cva([
...
//# sourceMappingURL=date-nav-variants.mjs.map