...
//#region src/Input/input-variants.ts
/**
* Input 的视觉变体。
*
...
*/
const inputVariants = cva(["relative flex w-full flex-col gap-1"], {
	variants: {
		variant: {
			outline: "",
			soft: ""
...
/** 前后缀图标槽位。 */
const inputIconVariants = cva(["inline-flex shrink-0 items-center justify-center text-foreground-muted", "[&_svg]:size-[1em] [&_svg]:shrink-0"]);
/** 清除按钮。 */
...
function resolveInputVariant(variant) {
