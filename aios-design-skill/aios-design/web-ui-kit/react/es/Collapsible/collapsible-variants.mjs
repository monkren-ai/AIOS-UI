...
//#region src/Collapsible/collapsible-variants.ts
/** Collapsible 外框。 */
const collapsibleVariants = cva("overflow-hidden rounded-md border border-border-visible", {
	variants: { open: {
		true: "",
		false: ""
	} },
...
/** 折叠区域的内容排版。 */
const collapsibleContentInnerVariants = cva("px-6 pb-4 font-body text-base leading-normal text-foreground-muted");
//#endregion
export { collapsibleContentInnerVariants, collapsibleContentVariants, collapsibleTriggerVariants, collapsibleVariants };

//# sourceMappingURL=collapsible-variants.mjs.map