...
//#region src/Countdown/countdown-variants.ts
/**
* Countdown 的视觉变体。
*
...
const countdownVariants = cva([
	...
	"transition-[opacity] duration-300 ease-aios motion-reduce:transition-none"
], {
	variants: { state: {
		running: "",
		urgent: "",
...
const countdownNumberVariants = cva([
	"aios-countdown__number",
...
//#endregion
export { countdownNumberVariants, countdownVariants };

//# sourceMappingURL=countdown-variants.mjs.map