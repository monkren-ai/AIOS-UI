...
//#region src/Resizable/resizable-variants.ts
/** 分栏容器。`horizontal` 是行方向，因此在 RTL 下由 flex 自动镜像。 */
const resizableVariants = cva(["flex h-full w-full"], {
	variants: { direction: {
		horizontal: "flex-row",
		vertical: "flex-col"
	} },
...
const resizablePanelVariants = cva(["min-h-0 min-w-0 overflow-hidden"]);
/**
...
//#endregion
export { resizableHandleVariants, resizablePanelVariants, resizableVariants };

//# sourceMappingURL=resizable-variants.mjs.map