...
//#region src/SystemMonitor/system-monitor-variants.ts
/**
* SystemMonitor 的视觉变体。
*
...
*/
const monitorItemVariants = cva(["mb-6 last:mb-0"], {
	variants: {
		type: {
			cpu: "",
			ram: "",
...
//#endregion
export { monitorItemDetailsVariants, monitorItemLabelVariants, monitorItemStatusVariants, monitorItemValueVariants, monitorItemVariants, monitorSegmentVariants, monitorTitleVariants, systemMonitorVariants };

//# sourceMappingURL=system-monitor-variants.mjs.map