...
//#region src/NumberField/number-field-variants.ts
/**
* NumberField 的视觉变体。
*
...
*/
const numberFieldVariants = cva(["relative flex w-full flex-col gap-1"], {
	variants: {
		size: {
			sm: "",
			md: "",
...
/** 字段标签。 */
const numberFieldLabelVariants = cva(["font-mono uppercase tracking-wider text-foreground-muted"], {
	variants: {
		size: {
			sm: "text-micro",
			md: "text-label",
...
/** 错误文案。 */
const numberFieldErrorVariants = cva(["mt-xs font-mono text-label uppercase tracking-wide text-accent"]);
//#endregion
export { numberFieldErrorVariants, numberFieldGroupVariants, numberFieldInputVariants, numberFieldLabelVariants, numberFieldStepperVariants, numberFieldVariants };

//# sourceMappingURL=number-field-variants.mjs.map