...
export const AIOS_DEFAULT_THEME_ID = 'aios-default'
export const DEFAULT_THEME_ID_STORAGE_KEY = 'aios-theme-id'
export const DEFAULT_THEME_SNAPSHOT_STORAGE_KEY = 'aios-theme-snapshot'

export const AIOS_BUILTIN_THEMES: readonly ThemeDefinition[] = [
  {
...
export function resolveThemeTokens(theme: ThemeDefinition, mode: ThemeMode): ThemeTokenValues {
...
export function applyThemeTokens(root: HTMLElement, values: ThemeTokenValues) {
