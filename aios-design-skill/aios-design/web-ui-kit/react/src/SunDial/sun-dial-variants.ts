...
export const sunDialArcDayVariants = cva([
  ...
  'transition-[stroke] duration-[350ms] ease-aios motion-reduce:transition-none',
])
...
export const sunDialSunMarkerVariants = cva([
  'transition-[transform,opacity] duration-[350ms] ease-aios motion-reduce:transition-none',
])

/** 太阳实心点。 */
export const sunDialSunCoreVariants = cva([
  'fill-warning transition-[fill] duration-[350ms] ease-aios motion-reduce:transition-none',
])

/** 太阳外圈的淡晕。是一个 20% 不透明度的实心圆，不是 blur。 */
export const sunDialSunGlowVariants = cva([
  'fill-warning opacity-20',
  'transition-[fill] duration-[350ms] ease-aios motion-reduce:transition-none',
])
