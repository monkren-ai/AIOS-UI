...
export const spinnerVariants = cva(
  [
    'flex flex-col items-center rounded-lg border transition-colors duration-300 ease-aios',
...
export const spinnerSectorVariants = cva(
  [
    ...
    'transition-[fill] duration-300 ease-aios motion-reduce:transition-none',
  ],
  {
    variants: {
      isEven: {
