...
describe('AgentOrb', () => {
  ...
  it('renders with default idle state', () => {
    ...
    expect(orb).toHaveClass('aios-agent-orb--idle')
  ...
  it('renders all states with correct classes and data attributes', () => {
    for (const state of states) {
      ...
      const orb = screen.getByRole('status')
      expect(orb).toHaveClass(`aios-agent-orb--${state}`)
  ...
  it('renders all sizes with correct classes and data attributes', () => {
    ...
    for (const size of sizes) {
      ...
      const orb = screen.getByRole('status')
      expect(orb).toHaveClass(`aios-agent-orb--${size}`)
  ...
  it('supports custom className', () => {
    ...
    expect(screen.getByRole('status')).toHaveClass('aios-agent-orb')
  })
