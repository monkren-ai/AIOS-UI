...
export const planCardVariants = cva('aios-plan-card', {
  variants: {
    editable: {
  ...
  (
    ...
    return (
      <div
        ...
        {...props}
      >
        <div className="aios-plan-card__header">
          <AgentOrb state={allApproved ? 'acting' : 'thinking'} size="sm" />
          <span className="aios-plan-card__title">{title}</span>
          <span className="aios-plan-card__count">
            {approvedCount}/{steps.length}
          </span>
        </div>

        <ol className="aios-plan-card__list" aria-label="Agent plan steps">
            ...
            return (
              ...
              >
                ...
                <div className="aios-plan-card__content">
                  <span className="aios-plan-card__description">{step.description}</span>
                  {step.tool && <span className="aios-plan-card__tool">{step.tool}</span>}
                </div>
                <span className="aios-plan-card__status">{statusLabels[status]}</span>
                {editable && (
                  <button
                    type="button"
        ...
        {(onApprove || onEdit || onApproveAll || onReset) && (
          <div className="aios-plan-card__actions">
            {(onApproveAll || onReset) && (
              <div className="aios-plan-card__actions-bulk">
                {onApproveAll && (
            ...
            <div className="aios-plan-card__actions-main">
              {onEdit && (
