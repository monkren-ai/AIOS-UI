...
describe('ThinkingIndicator', () => {
  ...
  it('renders with default thinking state', () => {
    ...
    expect(indicator).toHaveClass('aios-thinking-indicator--thinking')
  ...
  it('renders all states with correct classes and data attributes', () => {
    for (const state of states) {
      ...
      const indicator = screen.getByRole('status')
      expect(indicator).toHaveClass(`aios-thinking-indicator--${state}`)
  ...
  it('renders all sizes with correct classes and data attributes', () => {
    ...
    for (const size of sizes) {
      ...
      const indicator = screen.getByRole('status')
      expect(indicator).toHaveClass(`aios-thinking-indicator--${size}`)
  ...
  it('supports custom className', () => {
    ...
    expect(screen.getByRole('status')).toHaveClass('aios-thinking-indicator')
  })
