...
describe('ProgressTrace', () => {
  ...
  it('renders status classes and data attributes', () => {
    ...
    expect(items[0]).toHaveClass('aios-progress-trace__item--done')
    expect(items[0]).toHaveAttribute('data-status', 'done')
    expect(items[1]).toHaveClass('aios-progress-trace__item--active')
    expect(items[4]).toHaveClass('aios-progress-trace__item--error')
  })
  ...
  it('supports custom className', () => {
    ...
    expect(trace).toHaveClass('aios-progress-trace')
  })
