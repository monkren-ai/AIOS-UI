 ...
 */
export const autocompleteVariants = cva(['relative flex w-full flex-col gap-1'], {
  variants: {
    size: { sm: '', md: '', lg: '' },
...
export const autocompleteControlVariants = cva(
  [
...
export const autocompletePositionerVariants = cva(['z-[var(--z-overlay)]'])
...
export const autocompleteListVariants = cva(['max-h-60 overflow-y-auto py-1'])
...
export const autocompleteItemVariants = cva(
  ...
  ],
  {
    ...
    defaultVariants: { size: 'md', highlighted: false, disabled: false },
  },
)
...
/** 错误文案。 */
export const autocompleteErrorVariants = cva([
