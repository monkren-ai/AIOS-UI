...
export const widgetIconSvg: Record<string, string> = {
  ...
  dots: (() => {
    ...
    const circleTags = circles
      .map(([cx, cy]) => `<circle cx="${cx}" cy="${cy}" r="1.8" fill="black"/>`)
      .join('')
...
export const quickToggleSvg: Record<string, string> = {
  active:
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="black" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6L9 17l-5-5"/></svg>',
  torch:
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="black" stroke-width="2.5" stroke-linecap="round"><path d="M18 6L17 7M6 18l1-1M6 6l1 1M18 18l-1-1"/><circle cx="12" cy="12" r="4"/></svg>',
  ...
  rotate:
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="black" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 2v6h-6M3 12a9 9 0 0115-6.7L21 8M3 22v-6h6M21 12a9 9 0 01-15 6.7L3 16"/></svg>',
  hotspot:
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="black" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 12h.01M8.5 8.5a5 5 0 017 0M5 5a10 10 0 0114 0M19 5a10 10 0 010 14M5 5a10 10 0 000 14"/></svg>',
  bluetooth:
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="black" stroke-width="2.5" stroke-linecap="round"><path d="M6.5 6.5h11v11h-11z"/><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10"/></svg>',
  mobileData:
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="black" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 20h.01M7 20v-4M12 20v-8M17 20V8M22 20V4"/></svg>',
...
export const componentIconSvg: Record<string, string> = {
  ...
  batteryCharging:
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="black" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M13 2L4 14h6l-1 8 9-12h-6l1-8z"/></svg>',
  batteryLow:
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="black" stroke-width="2.5"><rect x="2" y="6" width="18" height="14" rx="2" ry="2"/><rect x="20" y="10" width="2" height="6" rx="1" fill="black"/><rect x="6" y="12" width="4" height="4" rx="1" fill="black"/></svg>',
  batteryNormal:
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="black" stroke-width="2.5"><rect x="2" y="6" width="18" height="14" rx="2" ry="2"/><rect x="20" y="10" width="2" height="6" rx="1" fill="black"/><rect x="6" y="10" width="8" height="6" rx="1" fill="black"/></svg>',

  // Device type icons (from Battery.tsx DeviceTypeIcon)
  deviceMouse:
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="black" stroke-width="2"><rect x="6" y="2" width="12" height="20" rx="6"/><line x1="12" y1="2" x2="12" y2="10"/></svg>',
  deviceKeyboard:
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="black" stroke-width="2"><rect x="1" y="6" width="22" height="12" rx="2"/><line x1="5" y1="10" x2="7" y2="10" stroke-linecap="round"/><line x1="9" y1="10" x2="11" y2="10" stroke-linecap="round"/><line x1="13" y1="10" x2="15" y2="10" stroke-linecap="round"/><line x1="17" y1="10" x2="19" y2="10" stroke-linecap="round"/><line x1="7" y1="14" x2="17" y2="14" stroke-linecap="round"/></svg>',
  deviceEarbuds:
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="black" stroke-width="2"><circle cx="7" cy="7" r="4"/><circle cx="17" cy="7" r="4"/><path d="M7 11v5a4 4 0 0 0 4 4" stroke-linecap="round"/><path d="M17 11v5a4 4 0 0 1-4 4" stroke-linecap="round"/></svg>',
  devicePhone:
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="black" stroke-width="2"><rect x="5" y="2" width="14" height="20" rx="2"/><line x1="10" y1="18" x2="14" y2="18" stroke-linecap="round"/></svg>',
  deviceWatch:
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="black" stroke-width="2"><circle cx="12" cy="12" r="6"/><path d="M9 2h6l-1 4H10L9 2z" stroke-linejoin="round"/><path d="M9 22h6l-1-4H10L9 22z" stroke-linejoin="round"/></svg>',

  // Taskbar icons (from Taskbar.tsx)
  startIcon:
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="black"><rect x="3" y="3" width="8" height="8" rx="1"/><rect x="13" y="3" width="8" height="8" rx="1"/><rect x="3" y="13" width="8" height="8" rx="1"/><rect x="13" y="13" width="8" height="8" rx="1"/></svg>',
  searchIcon:
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="black" stroke-width="2.5"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65" stroke-linecap="round"/></svg>',
  volumeIcon:
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="black"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15.54 8.46a5 5 0 0 1 0 7.07" fill="none" stroke="black" stroke-width="2"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14" fill="none" stroke="black" stroke-width="2"/></svg>',
}
