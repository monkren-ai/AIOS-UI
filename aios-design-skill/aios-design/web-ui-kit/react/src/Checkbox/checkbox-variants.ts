...
export const checkboxVariants = cva(
  [
    'group/checkbox inline-flex select-none items-center gap-2',
  ...
  ],
  {
    ...
    defaultVariants: { size: 'md', isChecked: false, indeterminate: false, disabled: false },
  },
)
...
export const checkboxIndicatorVariants = cva([
  'pointer-events-none flex items-center justify-center text-background',
])
...
/** 半选横线。 */
export const checkboxDashVariants = cva(
  [
