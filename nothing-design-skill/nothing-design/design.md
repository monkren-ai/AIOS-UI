...
The strategic read of the Nothing design system.
...
No ThreeJS scene detected. The Nothing design system does not prescribe a ThreeJS runtime. WebGL effects are implemented via canvas 2D dot-matrix particle fields, not ThreeJS geometry. This is an intentional restraint — the dot-matrix motif is achievable without a 3D engine.
...
| Neuform concept | Nothing adaptation |
|-----------------|---------------------|
...
```html
<section class="nothing-testimonials">
  <div class="nothing-testimonials__hero">
    <span class="nothing-testimonials__eyebrow">HEAR FROM THE TEAMS</span>
    <h2 class="nothing-testimonials__title">We've Partnered With</h2>
  </div>

  <div class="nothing-testimonials__grid">
    <!-- Featured (left, 60%) -->
    <article class="nothing-testimonial nothing-testimonial--featured">
      <span class="nothing-testimonial__marker" aria-hidden="true"></span>
      <blockquote class="nothing-testimonial__quote">
      ...
      <footer class="nothing-testimonial__attribution">
        <span class="nothing-testimonial__avatar" data-initials="MV"></span>
        <div class="nothing-testimonial__meta">
          <span class="nothing-testimonial__name">Marcus Vance</span>
          <span class="nothing-testimonial__role">CPO AT INNOVATE AI</span>
        </div>
      </footer>
    </article>

    <!-- Supporting (right, 40%, stacked) -->
    <div class="nothing-testimonials__supporting">
      <article class="nothing-testimonial">
        <blockquote class="nothing-testimonial__quote">Their agility without sacrificing quality helped us launch our MVP months ahead of schedule.</blockquote>
        <footer class="nothing-testimonial__attribution">
          <span class="nothing-testimonial__avatar" data-initials="CL"></span>
          <div class="nothing-testimonial__meta">
            <span class="nothing-testimonial__name">Clara Lin</span>
            <span class="nothing-testimonial__role">CTO AT NEXTGEN</span>
          </div>
        </footer>
      </article>
...
.nothing-testimonial--featured {
  /* asymmetric: larger, left-anchored */
  grid-column: 1 / 2;
}

.nothing-testimonial__quote {
...
.nothing-testimonial--featured .nothing-testimonial__marker {
