...
import { setPluginManager as setDumiPluginManager } from '/Users/ruishengzhang/Documents/GitHub/Nothing-UI/nothing-design-skill/nothing-design/web-ui-kit/react/node_modules/dumi/dist/client/theme-api/utils.js';
import { renderClient } from '/Users/ruishengzhang/Documents/GitHub/Nothing-UI/nothing-design-skill/nothing-design/web-ui-kit/react/node_modules/@umijs/renderer-react';
...
(function () {
  var cache = typeof navigator !== 'undefined' && navigator.cookieEnabled && typeof window.localStorage !== 'undefined' && localStorage.getItem('dumi:prefers-color') || 'dark';
