...
const Popover = React$1.forwardRef(({ className, content, side = "bottom", open: controlledOpen, onOpenChange, visible: _visible, children, ...props }, ref) => {
