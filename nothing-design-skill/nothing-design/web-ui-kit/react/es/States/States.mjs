...
const LoadingState = React$1.forwardRef(({ className, progress, totalSegments = 20, label, size = "md", style, ...props }, ref) => {
...
const ErrorState = React$1.forwardRef(({ className, headline, message, prefix, onRetry, size = "md", style, ...props }, ref) => {
	return /* @__PURE__ */ jsxs("div", {
		ref,
		className: cn(stateVariants({
			variant: "error",
...
const EmptyState = React$1.forwardRef(({ className, headline = "Nothing here", description, action, size = "md", style, ...props }, ref) => {
	return /* @__PURE__ */ jsxs("div", {
		ref,
		className: cn(stateVariants({
			variant: "empty",
...
const DisabledState = React$1.forwardRef(({ className, headline = "Unavailable", description, size = "md", style, ...props }, ref) => {
	return /* @__PURE__ */ jsxs("div", {
		ref,
		className: cn(stateVariants({
			variant: "disabled",
