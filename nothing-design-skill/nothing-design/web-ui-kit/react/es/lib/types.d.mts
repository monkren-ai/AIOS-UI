 ...
 * ```
 */
interface WithSemanticProps<T extends string> {
  /**
   * 语义化结构 className。
   */
 ...
 */
type ComponentConfig<T extends string> = Pick<WithSemanticProps<T>, 'classNames' | 'styles'>;
//#endregion
export { ComponentConfig, SemanticClassNames, SemanticStyles, WithSemanticProps };
