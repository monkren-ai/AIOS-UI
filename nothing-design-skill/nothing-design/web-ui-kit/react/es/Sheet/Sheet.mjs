...
const Sheet = React$1.forwardRef(({ className, open: controlledOpen, onOpenChange, side = "right", title, full = false, sections, footer, children, ...props }, ref) => {
	...
	const setSheetRefs = React$1.useCallback((node) => {
