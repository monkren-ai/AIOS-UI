...
const MusicPlayerMini = React$1.forwardRef(({ theme = "dark", size = "medium", className, style, ...props }, ref) => {
	return /* @__PURE__ */ jsx("div", {
		ref,
		style,
...
const MusicPlayerDefault = React$1.forwardRef(({ className, totalSegments = 20, updateInterval = 1e3, tracks: tracksProp, variant = "default", showRecordingIndicator = false, sourceIcon, recording = false, style, ...props }, ref) => {
...
const MusicPlayer = React$1.forwardRef(({ variant = "default", theme, size, className, style, ...props }, ref) => {
