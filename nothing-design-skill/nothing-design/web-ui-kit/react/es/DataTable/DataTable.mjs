...
const DataTable = React$1.forwardRef(({ className, variant = "table", columns, rows = [], caption, items = [], emptyMessage = "No data", onRowClick, striped = false, compact = false, hoverable = false, ...props }, ref) => {
	return /* @__PURE__ */ jsxs("div", {
		ref,
