...
//#region src/RadioGroup/radio-group-variants.ts
/**
* RadioGroup 的视觉变体。
*
...
/** 单个选项行。 */
const radioGroupItemVariants = cva(["group/radio relative inline-flex select-none items-center gap-2", "cursor-pointer [-webkit-tap-highlight-color:transparent]"], {
	variants: {
		size: {
			sm: "min-h-9",
			md: "min-h-11",
...
//#endregion
export { radioGroupCircleVariants, radioGroupDotVariants, radioGroupItemVariants, radioGroupLabelVariants, radioGroupVariants };

//# sourceMappingURL=radio-group-variants.mjs.map