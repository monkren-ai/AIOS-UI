...
const DateNav = React$1.forwardRef(({ className, label, prevDisabled = false, nextDisabled = false, grotesk = false, disabled = false, onPrev, onNext, initialDate, currentDate: currentDateProp, onDateChange, ...props }, ref) => {
