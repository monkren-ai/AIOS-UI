...
const MenubarVariant = ({ items }) => {
	...
	const handleTriggerClick = React.useCallback((index) => {
		setActiveIndex((prev) => prev === index ? null : index);
		setFocusItemIndex(0);
	}, []);
	const handleTriggerKeyDown = React.useCallback((index, e) => {
		switch (e.key) {
			case "ArrowRight":
				e.preventDefault();
				setActiveIndex((prev) => {
	...
	const handleDropdownKeyDown = React.useCallback((triggerIndex, e) => {
...
const DropdownMenu = React.forwardRef(({ className, trigger, items, align = "start", side = "bottom", variant = "default", visible: _visible, ...props }, ref) => {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("button", {
			...
			children: /* @__PURE__ */ jsx("div", {
				...
				children: defaultItems.map((item, index) => /* @__PURE__ */ jsxs(React.Fragment, { children: [/* @__PURE__ */ jsxs("div", {
					ref: (node) => {
