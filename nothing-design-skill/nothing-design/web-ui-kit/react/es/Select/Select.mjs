...
const Select = React$1.forwardRef(({ className, options, value: controlledValue, defaultValue, onValueChange, placeholder = "Select an option", disabled = false, hasError = false, label, error, searchable = false, ...props }, ref) => {
	...
	const getEnabledIndices = React$1.useCallback(() => {
...
//#endregion
export { Select as default, selectItemVariants, selectTriggerVariants, selectVariants };
