...
const AgeMotion = React$1.forwardRef(({ className, birthDate: initialBirthDate, lifespan = 80, updateInterval = 1e3, yearSegments = 20, size = "md", theme = "dark", style, ...props }, ref) => {
	const [birthDateStr, setBirthDateStr] = useState(initialBirthDate ?? "");
	const [now, setNow] = useState(/* @__PURE__ */ new Date());
	const birthDate = birthDateStr ? /* @__PURE__ */ new Date(birthDateStr + "T00:00:00") : null;
	useEffect(() => {
		if (!birthDate) return;
