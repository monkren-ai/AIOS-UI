...
const Accordion = React$1.forwardRef(({ className, items, type = "single", defaultOpen = [], ...props }, ref) => {
	const [openItems, setOpenItems] = React$1.useState(new Set(defaultOpen));
	const triggerRefs = React$1.useRef([]);
	const isOpen = (id) => openItems.has(id);
	const toggleItem = React$1.useCallback((id) => {
		setOpenItems((prev) => {
