...
//#region src/Accordion/accordion-variants.ts
/**
* Accordion 根容器。
*
...
/** 包裹 trigger 的标题元素。 */
const accordionHeaderVariants = cva("m-0");
...
/** 标题前置图标槽位。 */
const accordionLeadingIconVariants = cva("inline-flex shrink-0 items-center justify-center text-foreground-muted");
/** 末端的展开三角，展开时翻转 180°。 */
...
/** 面板内容。 */
const accordionContentVariants = cva("px-6 pb-4 font-body text-base leading-normal text-foreground-muted");
//#endregion
export { accordionContentVariants, accordionHeaderVariants, accordionItemVariants, accordionLeadingIconVariants, accordionPanelVariants, accordionTriggerIconVariants, accordionTriggerTextVariants, accordionTriggerVariants, accordionVariants };

//# sourceMappingURL=accordion-variants.mjs.map