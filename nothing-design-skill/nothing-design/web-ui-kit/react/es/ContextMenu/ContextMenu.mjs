...
const ContextMenu = React$1.forwardRef(({ className, items, visible: _visible, children, ...props }, ref) => {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			children: /* @__PURE__ */ jsx("div", {
				...
				"data-state": dataAttr(isOpen ? "open" : "closed"),
				children: items.map((item, index) => /* @__PURE__ */ jsxs(React$1.Fragment, { children: [/* @__PURE__ */ jsxs("div", {
					ref: (node) => {
