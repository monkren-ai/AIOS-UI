...
const ProgressBar = React$1.forwardRef(({ className, value, total = 100, segments = 20, size = "standard", variant = "default", indeterminate = false, label, unit, status = "default", showReadout = true, disabled = false, style, ...props }, ref) => {
