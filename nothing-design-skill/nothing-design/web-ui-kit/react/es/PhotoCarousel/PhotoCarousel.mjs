...
const PhotoCarousel = React.forwardRef(({ className, autoPlay = true, autoPlayInterval = 4e3, slides = defaultSlides, orientation = "horizontal", autoplay: autoplayProp, style, ...props }, ref) => {
