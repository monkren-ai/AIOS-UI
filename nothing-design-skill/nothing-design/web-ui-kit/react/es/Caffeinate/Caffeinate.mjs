...
const Caffeinate = React$1.forwardRef(({ className, updateInterval = 6e4, totalSegments = 10, maxCaffeine = 400, halfLifeMinutes = 300, thresholdMg = 50, status: statusProp, disabled = false, style, ...props }, ref) => {
