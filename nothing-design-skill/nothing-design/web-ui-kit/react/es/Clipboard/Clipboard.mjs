...
const Clipboard = React$1.forwardRef(({ className, maxItems = 5, truncateLength = 40, copiedDuration = 2e3, demoItems = defaultDemoItems, size = "md", state: stateProp, style, ...props }, ref) => {
