...
//#region src/DotMatrix/DotMatrix.tsx
...
const DotMatrix = React$1.forwardRef(({ className, rows, cols, dotSize = "md", theme = "light", pattern = "grid", activeDots = [], dimDots = [], style, ...props }, ref) => {
...
//#endregion
export { DotMatrix as default, dotMatrixVariants, dotVariants };

//# sourceMappingURL=DotMatrix.mjs.map