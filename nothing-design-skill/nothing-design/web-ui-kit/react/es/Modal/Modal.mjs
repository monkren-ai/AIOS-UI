...
const modalBackdropVariants = cva("nothing-modal-backdrop", {
	variants: {
		alert: {
			true: "nothing-modal-backdrop--blur",
			false: ""
		},
		visible: {
...
const Modal = React$1.forwardRef(({ className, open: controlledOpen, onClose, title, footer, children, variant = "default", description, confirmLabel = "Confirm", cancelLabel = "Cancel", onConfirm, onCancel, destructive = false, ...props }, ref) => {
	...
	const setDialogRefs = React$1.useCallback((node) => {
	...
	const titleId = title ? "nothing-modal-title" : void 0;
	const descriptionId = description ? "nothing-modal-description" : void 0;
