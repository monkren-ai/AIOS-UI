...
const Tag = React$1.forwardRef(({ className, variant = "pill", active = false, removable = false, disabled = false, children, onClick, onRemove, ...props }, ref) => {
...
Tag.displayName = "Tag";
const Tags = React$1.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsx("div", {
	ref,
