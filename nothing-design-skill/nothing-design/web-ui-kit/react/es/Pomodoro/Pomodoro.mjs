...
const Pomodoro = React$1.forwardRef(({ className, workMinutes = 25, breakMinutes = 5, totalSegments = 25, updateInterval = 1e3, phase: phaseProp, running: runningProp, style, ...props }, ref) => {
