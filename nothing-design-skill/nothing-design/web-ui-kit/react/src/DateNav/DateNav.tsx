...
import { dateNavArrowVariants, dateNavLabelVariants, dateNavVariants } from './date-nav-variants'
...
export type DateNavProps = React.ComponentPropsWithRef<'div'> & {
...
export function DateNav({
  ...
  return (
    ...
    >
      ...
      <div data-slot="date-nav-label" className={cn(dateNavLabelVariants({ grotesk }))}>
        {displayLabel}
      </div>
      <button
        type="button"
