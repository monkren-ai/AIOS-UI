...
export const checkboxGroupVariants = cva(['relative inline-flex gap-xs'], {
  variants: {
    orientation: {
 ...
 */
export const checkboxGroupMergeBgVariants = cva([
...
/** 单个选项的点击区。 */
export const checkboxGroupItemVariants = cva(['relative z-1 rounded-md px-2 py-1'], {
  variants: {
    selected: {
      true: '',
      false: '',
