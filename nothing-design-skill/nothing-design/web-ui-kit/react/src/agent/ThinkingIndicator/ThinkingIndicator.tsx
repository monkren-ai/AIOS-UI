...
export const thinkingIndicatorVariants = cva('nothing-thinking-indicator', {
  variants: {
    state: {
      ...
      >
        ...
        >
          {(state === 'thinking' || state === 'acting') && (
            <g className="nothing-thinking-indicator__dots">
              <circle cx="6" cy="12" r="2" className="nothing-thinking-indicator__dot" />
              <circle cx="12" cy="12" r="2" className="nothing-thinking-indicator__dot" />
              <circle cx="18" cy="12" r="2" className="nothing-thinking-indicator__dot" />
            </g>
          )}
          {state === 'done' && (
            <path
