...
export const previewCardMediaVariants = cva(['relative w-full overflow-hidden'], {
  variants: {
    size: {
      sm: 'h-24',
      md: 'h-36',
...
export const previewCardBodyVariants = cva(['flex flex-col'], {
  variants: {
    size: {
      sm: 'p-3 gap-2',
      md: 'p-4 gap-3',
...
export const previewCardFooterVariants = cva(
...
export type PreviewCardVariant = 'default' | 'raised' | 'compact'
