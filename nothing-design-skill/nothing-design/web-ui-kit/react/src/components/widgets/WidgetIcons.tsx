...
export function Watch({ theme = 'dark', size = 'md', variant, className, 'aria-label': ariaLabel, style }: WidgetIconProps) {
  ...
  return (
    ...
    >
      <g id="Watch Hands">
        <rect fill={iconFill} height="24" rx="4" transform="rotate(-60 15.2106 27.2254)" width="8" x="15.2106" y="27.2254" />
        <rect fill="var(--widget-grey, #AEABB1)" height="28" rx="1" transform="rotate(60 56.5391 18.8007)" width="2" x="56.5391" y="18.8007" />
...
export const WidgetIconList = [
  ...
  Cast, DoNotDisturbLight, ArrowDownAlt, QrCodeLight, SubtitleLight, Scan, CastAlt, BatteryPlus
];
