...
function Frame24() {
  return (
    <div className="widget-card__icon h-[48px] widget-relative widget-shrink-0 w-[6px]" aria-hidden="true">
      <svg className="nothing-widget-icon-svg" fill="none" preserveAspectRatio="xMidYMid meet" viewBox="0 0 6 48">
        <g id="Frame 40">
...
function Frame25() {
  return (
    <div className="widget-card__icon h-[34px] widget-relative widget-shrink-0 w-[6px]" aria-hidden="true">
      <svg className="nothing-widget-icon-svg" fill="none" preserveAspectRatio="xMidYMid meet" viewBox="0 0 6 34">
        <g id="Frame 41">
          <circle cx="3" cy="3" fill="currentColor" fillOpacity="1" id="Ellipse 133" r="3" />
          <circle cx="3" cy="10" fill="currentColor" fillOpacity="1" id="Ellipse 187" r="3" />
          <circle cx="3" cy="17" fill="currentColor" fillOpacity="1" id="Ellipse 188" r="3" />
...
function Frame26() {
  return (
    <div className="widget-card__icon h-[20px] widget-relative widget-shrink-0 w-[6px]" aria-hidden="true">
      <svg className="nothing-widget-icon-svg" fill="none" preserveAspectRatio="xMidYMid meet" viewBox="0 0 6 20">
        <g id="Frame 42">
...
function Frame27() {
  return (
    <div className="widget-relative widget-shrink-0 size-[6px]" aria-hidden="true">
      <svg className="nothing-widget-icon-svg" fill="none" preserveAspectRatio="xMidYMid meet" viewBox="0 0 6 6">
        <g id="Frame 43">
...
export const Dots5 = React.forwardRef<HTMLDivElement, WidgetSubProps>(
  ({ theme, size, className, 'aria-label': ariaLabel, style, ...props }, ref) => {
    return (
      <div ref={ref} style={style} className={cn(widgetSubVariants({ theme, size }), `absolute bottom-[8px] left-1/2 -translate-x-1/2 content-stretch flex gap-px items-center w-[27px] ${className || ''}`.trim())} data-theme={dataAttr(theme)} data-size={dataAttr(size)} {...props} data-name="Dots" aria-label={ariaLabel || "Dots"}>
      <Frame24 />
      <Frame25 />
      <Frame26 />
      <Frame27 />
...
export const Play = React.forwardRef<HTMLDivElement, WidgetSubProps>(
  ({ theme, size, className, 'aria-label': ariaLabel, style, ...props }, ref) => {
    return (
      <div ref={ref} style={style} className={cn(widgetSubVariants({ theme, size }), `widget-card-wrapper ${className || ''}`.trim())} data-theme={dataAttr(theme)} data-size={dataAttr(size)} {...props} data-name="Play" aria-label={ariaLabel || "Play"}>
