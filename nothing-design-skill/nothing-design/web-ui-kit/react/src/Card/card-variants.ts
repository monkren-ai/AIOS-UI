...
export const contentCardVariants = cva(
  ['border transition-colors duration-200 ease-nothing', 'motion-reduce:transition-none'],
  {
    variants: {
      variant: {
...
/** Widget 主数值。 */
export const widgetCardValueVariants = cva(['font-ndot font-light leading-tight tracking-tight'], {
  variants: {
    theme: {
