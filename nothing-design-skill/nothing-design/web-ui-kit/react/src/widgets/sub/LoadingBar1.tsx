...
function Frame7() {
  return (
    <div
      className="widget-col-1 h-[3px] ml-0 mt-[11px] widget-relative widget-row-1 w-[118.5px]"
      aria-hidden="true"
    >
      <svg
      ...
      >
        <g id="Frame 13">
          ...
          <circle
            cx="67.5"
            cy="1.5"
            fill="var(--fill-0, var(--widget-dark-2))"
            id="Ellipse 119"
            r="1.5"
...
function Human() {
  return (
    <div
      className="widget-col-1 h-[23px] ml-[49px] mt-0 widget-relative widget-row-1 w-[18px]"
      data-name="Human"
      aria-hidden="true"
    >
      <svg
  ...
  ({ theme, size, className, 'aria-label': ariaLabel, style, ...props }, ref) => {
    return (
      <div
        ...
        aria-label={ariaLabel || 'Loading Bar'}
      >
        <Frame7 />
        <Human />
      </div>
