    ...
    return (
      <div
        ...
        className={cn(
          ...
          `absolute h-[24px] left-[1.4px] top-[4px] w-[29.192px] ${className || ''}`.trim(),
        )}
        ...
        >
          <g id="Group 20">
            <path
              d={svgPaths.p205ee00}
              id="Ellipse 228"
              stroke="var(--fill-0, var(--widget-white))"
              strokeWidth="3"
              style={{ stroke: 'var(--widget-white)', strokeOpacity: '1' }}
            />
            <circle
              cx="14.5961"
              cy="14.0644"
  ...
  ({ theme, size, className, 'aria-label': ariaLabel, style, ...props }, ref) => {
    return (
      <div
        ...
        className={cn(
          widgetSubVariants({ theme, size }),
          `widget-overflow-clip widget-relative widget-shrink-0 size-[32px] ${className || ''}`.trim(),
        )}
        data-theme={dataAttr(theme)}
        data-size={dataAttr(size)}
        {...props}
      ...
      >
        <div className="flex flex-col items-center justify-center size-full">
          <div className="content-stretch flex flex-col gap-[32px] items-center justify-center p-[16px] widget-relative size-full">
            <p
              className=" widget-text widget-text--16 widget-text--grey widget-text--center widget-text--nowrap"
