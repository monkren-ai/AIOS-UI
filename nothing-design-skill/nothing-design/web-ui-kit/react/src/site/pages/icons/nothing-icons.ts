...
export const NOTHING_GROUPS: IconGroup[] = [
...
export const NOTHING_ICONS: IconEntry[] = [
...
/** 每个分组的图标数量，侧栏的计数用。 */
export const NOTHING_GROUP_COUNTS: Record<string, number> = NOTHING_ICONS.reduce<
