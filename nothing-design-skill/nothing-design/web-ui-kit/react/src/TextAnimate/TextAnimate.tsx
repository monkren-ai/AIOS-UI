...
const REVEAL_ONCE =
  'motion-safe:animate-[nothing-text-reveal_var(--nothing-text-duration,300ms)_var(--ease-nothing)_1_both]'
const REVEAL_LOOP =
  'motion-safe:animate-[nothing-text-reveal_var(--nothing-text-duration,300ms)_var(--ease-nothing)_infinite_both]'
...
export function TextAnimate({
  ...
  const segmentClass = cn(
    'nothing-text-animate__segment inline-block will-change-[opacity,transform]',
