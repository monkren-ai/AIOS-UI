  ...
  return (
    <>
      ...
      <section style={flexWrapSectionStyle}>
        ...
        <div style={figmaWidgetWrapStyle}><WidgetPill preset="mobileData" /></div><div style={figmaWidgetWrapStyle}><WidgetPill preset="batteryShare" /></div><div style={figmaWidgetWrapStyle}><WidgetPill preset="calculator" /></div><div style={figmaWidgetWrapStyle}><WidgetPill preset="batterySaver" /></div>
      </section>

      <section style={flexWrapSectionStyle}>
        <h2 style={demoTitleStyle}>Figma 2.0 — Dark Pills</h2>
        <div style={figmaWidgetWrapStyle}><WidgetPill preset="homeControls" /></div><div style={figmaWidgetWrapStyle}><WidgetPill preset="nfc" /></div><div style={figmaWidgetWrapStyle}><WidgetPill preset="bedtime" /></div><div style={figmaWidgetWrapStyle}><WidgetPill preset="darkMode" /></div>
      </section>

      <section style={flexWrapSectionStyle}>
        <h2 style={demoTitleStyle}>Figma 2.0 — Accent Pills</h2>
        <div style={figmaWidgetWrapStyle}><WidgetPill preset="weather" /></div><div style={figmaWidgetWrapStyle}><WidgetPill preset="tvRemote" /></div><div style={figmaWidgetWrapStyle}><WidgetPill preset="storage" /></div><div style={figmaWidgetWrapStyle}><WidgetPill preset="hotspot" /></div>
      </section>

      <section style={flexWrapSectionStyle}>
        <h2 style={demoTitleStyle}>Figma 2.0 — More Pills</h2>
        <div style={figmaWidgetWrapStyle}><WidgetPill preset="nearbyShare" /></div><div style={figmaWidgetWrapStyle}><WidgetPill preset="extraDim" /></div><div style={figmaWidgetWrapStyle}><WidgetPill preset="dataSaver" /></div><div style={figmaWidgetWrapStyle}><WidgetPill preset="torch" /></div><div style={figmaWidgetWrapStyle}><WidgetPill preset="bluetooth" /></div>
      </section>

      <section style={flexWrapSectionStyle}>
        <h2 style={demoTitleStyle}>Figma 2.0 — Circular Widgets</h2>
        <div style={figmaWidgetWrapStyle}><Recording variant="rec" /></div><div style={figmaWidgetWrapStyle}><LocationAccess /></div><div style={figmaWidgetWrapStyle}><FigmaWatch variant="analog-large" /></div><div style={figmaWidgetWrapStyle}><FigmaCompass /></div><div style={figmaWidgetWrapStyle}><TempControl /></div><div style={figmaWidgetWrapStyle}><AutoRotate1 /></div>
      </section>

      <section style={flexWrapSectionStyle}>
        <h2 style={demoTitleStyle}>Figma 2.0 — Location Widgets</h2>
        <div style={figmaWidgetWrapStyle}><LocationAccess /></div><div style={figmaWidgetWrapStyle}><LocationAccess theme="light" /></div>
      </section>

      <section style={flexWrapSectionStyle}>
        <h2 style={demoTitleStyle}>Figma 2.0 — Watch Widgets</h2>
        <div style={figmaWidgetWrapStyle}><FigmaWatch variant="analog-large" /></div><div style={figmaWidgetWrapStyle}><FigmaWatch variant="analog" /></div>
      </section>

      <section style={flexWrapSectionStyle}>
        <h2 style={demoTitleStyle}>Figma 2.0 — Active Widgets</h2>
        <div style={figmaWidgetWrapStyle}><Active /></div><div style={figmaWidgetWrapStyle}><FigmaWatch variant="analog" /></div><div style={figmaWidgetWrapStyle}><Active variant="aeroplane" /></div><div style={figmaWidgetWrapStyle}><Recording /></div><div style={figmaWidgetWrapStyle}><FigmaGlyphs /></div><div style={figmaWidgetWrapStyle}><LocationAccess theme="light" /></div>
      </section>

      <section style={flexWrapSectionStyle}>
        <h2 style={demoTitleStyle}>Figma 2.0 — Glyph Widgets</h2>
        <div style={figmaWidgetWrapStyle}><FigmaGlyphs variant="pattern-b" /></div><div style={figmaWidgetWrapStyle}><Campus /></div><div style={figmaWidgetWrapStyle}><Location1 /></div><div style={figmaWidgetWrapStyle}><Flash /></div><div style={figmaWidgetWrapStyle}><FigmaWeather variant="icon" /></div><div style={figmaWidgetWrapStyle}><MicAccess /></div>
      </section>

      <section style={flexWrapSectionStyle}>
        <h2 style={demoTitleStyle}>Figma 2.0 — Pair & Limit Widgets</h2>
        <div style={figmaWidgetWrapStyle}><PairNewDevice /></div><div style={figmaWidgetWrapStyle}><Overlimit /></div><div style={figmaWidgetWrapStyle}><FigmaMusicPlayer /></div><div style={figmaWidgetWrapStyle}><FigmaTime variant="total" /></div>
      </section>

      <section style={flexWrapSectionStyle}>
        <h2 style={demoTitleStyle}>Figma 2.0 — Counter Widgets</h2>
        <div style={figmaWidgetWrapStyle}><StepsCounter /></div><div style={figmaWidgetWrapStyle}><OverLimit theme="dark" minutes={40} /></div><div style={figmaWidgetWrapStyle}><LoadingBar1 /></div><div style={figmaWidgetWrapStyle}><FigmaCard /></div>
      </section>

      <section style={flexWrapSectionStyle}>
        <h2 style={demoTitleStyle}>Figma 2.0 — Card Widgets</h2>
        <div style={figmaWidgetWrapStyle}><FigmaCard image="b" /></div><div style={figmaWidgetWrapStyle}><Dots3 /></div><div style={figmaWidgetWrapStyle}><Play /></div><div style={figmaWidgetWrapStyle}><NothingEar /></div>
      </section>

      <section style={flexWrapSectionStyle}>
        <h2 style={demoTitleStyle}>Figma 2.0 — Date & Music Widgets</h2>
        <div style={figmaWidgetWrapStyle}><FigmaCard image="c" /></div><div style={figmaWidgetWrapStyle}><FigmaDate /></div><div style={figmaWidgetWrapStyle}><Date1 /></div><div style={figmaWidgetWrapStyle}><Counter /></div>
      </section>
      ...
      <section style={sectionStyle}>
        ...
        <FigmaCard variant="pill" image="d" style={{ background: 'var(--widget-bg)', padding: '24px', borderRadius: '24px', overflow: 'auto' }} />
      </section>
      ...
      <section style={sectionStyle}>
        ...
        <FigmaTime variant="compact" style={{ background: 'var(--widget-bg)', padding: '24px', borderRadius: '24px', overflow: 'auto' }} />
      </section>

      <section style={sectionStyle}>
        <h2 style={demoTitleStyle}>Figma 2.0 — Wide Weather Widget</h2>
        <FigmaWeather variant="forecast" style={{ background: 'var(--widget-bg)', padding: '24px', borderRadius: '24px', overflow: 'auto' }} />
      </section>
    </>
  )
}
