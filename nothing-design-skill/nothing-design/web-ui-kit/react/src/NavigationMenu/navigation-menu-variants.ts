...
/** NavigationMenu 根导航。 */
export const navigationMenuVariants = cva('font-mono text-sm', {
  variants: {
    orientation: {
      horizontal: '',
      vertical: '',
...
/** menubar / menu 列表。 */
export const navigationMenuListVariants = cva('m-0 flex list-none p-0', {
  variants: {
    orientation: {
 ...
 */
export const navigationMenuCaretVariants = cva(
  'ms-1 inline-block size-0 shrink-0 border-x-4 border-x-transparent border-t-4 border-t-current',
)
 ...
 */
export const navigationMenuSubmenuVariants = cva(
  [
...
/** 子菜单里的一行。 */
export const navigationMenuSubmenuItemVariants = cva('list-none')

/** 子菜单链接。 */
export const navigationMenuSubmenuLinkVariants = cva([
