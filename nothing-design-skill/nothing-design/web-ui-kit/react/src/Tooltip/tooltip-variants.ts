...
export const tooltipPositionerVariants = cva('z-[var(--z-tooltip)]')
  ...
  ],
  {
    variants: {
      ...
      side: {
        ...
        bottom:
          'after:-top-1 after:inset-x-0 after:mx-auto after:border-x-4 after:border-b-4 after:border-x-transparent after:border-b-surface-raised',
        ...
        right:
          'after:-start-1 after:inset-y-0 after:my-auto after:border-y-4 after:border-e-4 after:border-y-transparent after:border-e-surface-raised',
      },
    },
