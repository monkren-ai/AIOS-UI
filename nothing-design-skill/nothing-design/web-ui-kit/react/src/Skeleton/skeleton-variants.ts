...
export const skeletonVariants = cva(
  [
    'nothing-skeleton',
    'relative grid gap-0.5 overflow-hidden opacity-60',
  ],
  {
    variants: {
      variant: {
    ...
    defaultVariants: { variant: 'text', animate: true },
  },
)
 ...
 */
export const skeletonDotVariants = cva(
  ['nothing-skeleton__dot', 'size-[3px] rounded-full bg-foreground-disabled'],
  {
    variants: {
      variant: {
        text: '',
