    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            {loading ? (
              <span className="nothing-bubble__loading" aria-label="Loading">
                <span className="nothing-bubble__loading-dot" />
                <span className="nothing-bubble__loading-dot" />
                <span className="nothing-bubble__loading-dot" />
              </span>
            ) : (
              <>
                {displayed}
                {isTyping && <span className="nothing-bubble__cursor" aria-hidden="true" />}
              </>
            )}
          </div>
