...
export const modalCloseVariants = cva(
  ...
  {
    variants: {
      noHeader: { true: 'top-2 end-2', false: 'top-4 end-4' },
    },
...
export const modalHeaderVariants = cva('border-b border-border p-6', {
  variants: {
    alert: { true: 'pe-6', false: 'pe-[60px]' },
  },
  defaultVariants: { alert: false },
})

export const modalTitleVariants = cva('font-mono text-subheading uppercase tracking-wide', {
  variants: {
    alert: { true: 'mb-1', false: '' },
    destructive: { true: 'text-accent', false: 'text-foreground' },
  },
  defaultVariants: { alert: false, destructive: false },
})

export const modalDescriptionVariants = cva('font-body text-base text-foreground-muted')

export const modalBodyVariants = cva('p-6 font-body text-base text-foreground')
