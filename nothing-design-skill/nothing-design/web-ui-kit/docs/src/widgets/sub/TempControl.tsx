...
function Frame() {
  return (
    <div
      className="content-stretch flex gap-[7px] items-center widget-relative widget-shrink-0"
      aria-hidden="true"
    >
      <div
        className="widget-overflow-clip widget-relative widget-shrink-0 widget-card__svg--16"
        data-name="Icon/Arrow-Upward"
      >
      ...
      <p
        className=" widget-text widget-text--light widget-text--28 widget-text--grey3 widget-text--nowrap"
...
function Info2() {
  return (
    <div
      className="content-stretch flex flex-col gap-[4px] items-start justify-center widget-relative widget-shrink-0"
      data-name="Info"
      aria-hidden="true"
    >
      <Frame />
    ...
    return (
      <div
        ...
        className={cn(
          ...
          `widget-card widget-card--152 widget-card--pill widget-card--light content-stretch flex flex-col items-center justify-center widget-relative widget-shrink-0 ${className || ''}`.trim(),
        )}
        data-theme={dataAttr(theme)}
        data-size={dataAttr(size)}
        {...props}
        data-name="Temp Control"
        aria-label={ariaLabel || 'Temp Control'}
      >
        <Info2 />
      </div>
    )
