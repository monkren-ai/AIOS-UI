  ...
  ({ theme, size, className, 'aria-label': ariaLabel, style, ...props }, ref) => {
    return (
      <div
        ...
        data-size={dataAttr(size)}
        {...props}
        data-name="Nothing Ear 2"
        aria-label={ariaLabel || 'Nothing Ear 2'}
      >
        <div
        ...
        />
        <Image />
        <p className=" absolute bottom-[16px] left-1/2 -translate-x-1/2 widget-text widget-text--ndot widget-text--16 widget-text--grey2 widget-text--center widget-text--uppercase widget-text--nowrap widget-leading-19">
          CONNECT
        </p>
      </div>
    )
