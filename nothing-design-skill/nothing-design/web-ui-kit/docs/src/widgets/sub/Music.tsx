    ...
    return (
      <div
        ...
        className={cn(
          ...
          `widget-card__icon absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 h-[47.511px] w-[48px] ${className || ''}`.trim(),
        )}
        data-theme={dataAttr(theme)}
        data-size={dataAttr(size)}
        {...props}
        aria-label={ariaLabel || 'Group1'}
      >
        <svg
          className="nothing-widget-icon-svg"
          fill="none"
          preserveAspectRatio="xMidYMid meet"
          viewBox="0 0 48 47.5107"
        >
          <g id="Group 1">
            <circle
              cx="20.9857"
  ...
  ({ theme, size, className, 'aria-label': ariaLabel, style, ...props }, ref) => {
    return (
      <div
        ...
        {...props}
        data-name="Music"
        aria-label={ariaLabel || 'Music'}
      >
        <div
          className="widget-bg-dark absolute inset-0 widget-card--rounded size-[152px]"
          data-name="BG"
        />
        <Group1 />
      </div>
