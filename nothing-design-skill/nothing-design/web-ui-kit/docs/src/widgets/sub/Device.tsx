    ...
    return (
      <div
        ...
        className={cn(
          ...
          `widget-card__icon absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 h-[75px] w-[46px] ${className || ''}`.trim(),
        )}
...
export const Device = React.forwardRef<HTMLDivElement, WidgetSubProps>(
  ({ theme, size, className, 'aria-label': ariaLabel, style, ...props }, ref) => {
    return (
      ...
      >
        <div
          className="widget-bg-light absolute inset-0 widget-card--rounded size-[152px]"
          data-name="BG"
        />
        <Dots7 />
      </div>
