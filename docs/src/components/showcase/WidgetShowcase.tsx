      ...
      <div className="widget-showcase">
        <main className="bento">
          ...
          <NfCard
            ...
            label="Clock · Swiss"
            tag="LIVE"
            body={<Time variant="analog" dial="swiss" card />}
          />
          <NfCard
            index={5}
            label="Clock · Minimalist"
            tag="LIVE"
            body={<Time variant="analog" dial="minimalist" card />}
          />
          <NfCard
            index={6}
            label="Clock · Smooth"
            tag="LIVE"
            body={<Time variant="analog" dial="swiss" smoothSeconds card={{ theme: 'light' }} />}
          />
          ...
          <NfCard
            ...
            label="Digital · Sharp"
            tag="LIVE"
            body={<Time variant="digital-large" font="sharp" card />}
          />
          <NfCard
            index={8}
            label="Digital · Serif"
            tag="LIVE"
            body={<Time variant="digital-large" font="serif" card />}
          />
          <NfCard
            index={9}
            label="Digital · Seconds"
            tag="LIVE"
            body={
          ...
          <NfCard
            ...
            label="Battery · Ring"
            tag="LIVE"
            body={<Battery variant="ring" percent={45} widgetMode="ring" />}
          />

          {/* Date */}
          <NfCard index={16} label="Date · Serif" tag="LIVE" body={<DateWidget type="serif" />} />
          <NfCard
            index={17}
            label="Date · Peel"
            tag="LIVE"
            body={<DateWidget type="serif" showPeel theme="light" />}
          />
          ...
          <NfCard
            ...
            label="Music · Compact"
            tag="LIVE"
            body={<MusicPlayer variant="compact" showRecordingIndicator />}
          />
          <NfCard
            index={19}
            label="Music · Default"
            tag="LIVE"
            body={<MusicPlayer variant="default" showRecordingIndicator />}
          />
