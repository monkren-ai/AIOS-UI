...
function Frame3() {
  return (
    <div
      className="content-stretch flex gap-[6px] items-start widget-relative widget-shrink-0"
      aria-hidden="true"
    >
      ...
      <p
        className=" widget-text widget-text--10 widget-text--grey3 widget-text--nowrap"
...
function Frame4() {
  return (
    ...
    >
      <div
        className="widget-card__icon h-[9px] widget-relative widget-shrink-0 w-[11px]"
        data-name="Vector"
      >
        <svg
...
function Frame5() {
  return (
    <div
      className="content-stretch flex flex-col gap-[16px] h-[68px] items-start justify-center widget-relative widget-shrink-0 w-[77px]"
      aria-hidden="true"
    >
      <Frame3 />
      <Frame2 />
    ...
    return (
      <div
        ...
        className={cn(
          ...
          `widget-card widget-card--152 widget-card--pill widget-card--light content-stretch flex flex-col items-center justify-center p-[10px] widget-relative widget-shrink-0 ${className || ''}`.trim(),
        )}
