...
function CompactDisplay() {
  return (
    <>
      ...
      <div className="widget-col-1 ml-[13px] mt-[40px] widget-relative widget-row-1 widget-text widget-text--dotmatrix widget-text--32 widget-text--grey widget-text--center widget-text--nowrap">
