...
export const aicssDoc: ComponentDoc = {
  ...
  composition: {
    zh: "覆盖 AIcss 现行目录的 14 件，外加 `AicssWebSearch`。兼容导出保持不变；`AicssCodeBlock` 与 `AicssFileDiff` 已改为复用新的 AIOS `CodeBlock` / `CodeDiff` 原语。",
    en: "Covers the current 14-piece AIcss catalog plus `AicssWebSearch`. Compatibility exports stay intact; `AicssCodeBlock` and `AicssFileDiff` now reuse the new AIOS `CodeBlock` and `CodeDiff` primitives.",
  },
  examples: [
    {
      id: "thinking",
    ...
    },
    {
      ...
      props: [
        ...
        },
        {
          ...
          description: {
            zh: "增强进行中。",
            en: "Prompt enhancement in progress.",
          },
        },
      ],
    },
